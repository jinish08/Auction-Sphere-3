...
describe('ProductCard Component', () => {
    ...
    test('renders product information correctly', () => {
        render(
            <Router>
                <ProductCard product={mockProduct} maxBid={mockMaxBid} name={mockName} />
            </Router>
        );
        ...
        expect(screen.getByText(/Current highest bids: \$75/i)).toBeInTheDocument();
        expect(screen.getByText(/Current highest bidder: Jane K/i)).toBeInTheDocument();
    });
    ...
    test('renders "N/A" for max bid if maxBid is -1', () => {
        render(
            <Router>
                <ProductCard product={mockProduct} maxBid={-1} name={mockName} />
            </Router>
        );

        expect(screen.getByText((content, element) => 
            content.includes("Current highest bids: $N/A"))).toBeInTheDocument()
    });
