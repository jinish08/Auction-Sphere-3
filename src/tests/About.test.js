...
describe('About Component', () => {
    test('renders welcome text', () => {
        render(<About/>);
        expect(screen.getByText('Welcome to Auction-Sphere!')).toBeInTheDocument();
    });
    ...
    test('renders first tag line', () => {
        ...
        expect(
            screen.getByText((content, element) => 
                content.startsWith('One-stop shop for your favourite items') &&
    ...
    test('renders second tag line', () => {
        ...
        expect(
            screen.getByText((content, element) => 
                content.endsWith('Bid for exciting items and grab your favourite!') &&
                element.tagName.toLowerCase() === 'p'
            )
        ).toBeInTheDocument();
    });
